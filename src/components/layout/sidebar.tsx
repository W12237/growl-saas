...
const icons: Record<string, React.ReactNode> = {
  ...
  tasks: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="m9 11 3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>,
...
const navLinks: NavLink[] = [
  ...
  { label: 'Tasks', href: '/dashboard/tasks', icon: 'tasks', section: 'work' },
