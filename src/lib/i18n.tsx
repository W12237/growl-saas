...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Tasks Module
    'tasks.title': 'Team Task Manager',
    'tasks.subtitle': 'Assign tasks to team members, link projects, track deadlines, and monitor execution.',
    'tasks.addTask': 'Assign Task',
    'tasks.selectProject': 'Select Target Project',
    'tasks.selectAssignee': 'Assign Team Member',
    'tasks.taskTitle': 'Task Title',
    'tasks.description': 'Description & Requirements',
    ...
    'tasks.noTasks': 'No tasks assigned yet. Click "Assign Task" to create one.',
  ...
  ar: {
    ...
    // Tasks Module
    'tasks.title': 'إدارة مهام الفريق',
    'tasks.subtitle': 'تعيين المهام لأعضاء الفريق، ربطها بالمشاريع، متابعة المواعيد النهائية ومراقبة التنفيذ.',
    'tasks.addTask': 'إضافة مهمة',
    'tasks.selectProject': 'اختر المشروع',
    'tasks.selectAssignee': 'تعيين إلى عضو الفريق',
    'tasks.taskTitle': 'عنوان المهمة',
    'tasks.description': 'الوصف والمتطلبات',
    'tasks.dueDate': 'تاريخ الاستحقاق',
    'tasks.priority': 'مستوى الأولوية',
    'tasks.priority.low': 'منخفضة',
    'tasks.priority.medium': 'متوسطة',
    'tasks.priority.high': 'عالية',
    'tasks.priority.urgent': 'عاجلة جداً',
    ...
    'tasks.noTasks': 'لا توجد مهام مسجلة. انقر فوق "إضافة مهمة" لإنشاء مهمة جديدة.',
