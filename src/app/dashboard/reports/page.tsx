      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6 shrink-0">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-black text-[var(--color-text-primary)] tracking-tight">{t('reports.title')}</h1>
          </div>
          <p className="text-[var(--color-text-muted)] text-sm">{t('reports.subtitle')}</p>
        </div>
